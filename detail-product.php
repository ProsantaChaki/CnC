                ...
                <section class="related-product wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                    <div class="container">
                        ...
                        <div class="owl-carousel owl-theme" data-items="4" data-laptop="3" data-tablet="2" data-mobile="1" data-nav="false" data-dots="true" data-autoplay="true" data-speed="1800" data-autotime="5000">
							<?php
								$tag_condition = " where p.product_id != ".$product_id." and p.availability=1  ";
								if(!empty($tags_arr)){
									$tag_condition .= " and (";
									foreach ($tags_arr as $key=>$val){
										if($val != "" && $val != " ")
								...
								$sql = "select p.product_id,p.name,p.code, pm.product_image, round(pr.rate,1) rate, p.category_id, c.name category_name, s.name size_name
																			from products p 
								...
								$related_product_info =  $dbClass->getResultList($sql);																		
