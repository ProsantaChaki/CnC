...
-- Dumping data for table cakencookies.banner_image: ~1 rows (approximately)
...
-- Dumping data for table cakencookies.gallary_images: ~4 rows (approximately)
...
-- Dumping data for table cakencookies.order_details: ~5 rows (approximately)
...
-- Dumping data for table cakencookies.order_master: ~5 rows (approximately)
...
-- Dumping data for table cakencookies.products: ~35 rows (approximately)
...
-- Dumping data for table cakencookies.product_ingredient: ~136 rows (approximately)
...
-- Dumping data for table cakencookies.product_rate: ~35 rows (approximately)
...
-- Dumping data for table cakencookies.web_menu: ~23 rows (approximately)
...
INSERT INTO `web_menu` (`id`, `parent_menu_id`, `title`, `menu`, `description`) VALUES
	...
	(48, NULL, 'Special Menu', 'Special Menu', '<p>The role of a good cook ware in the preparation of a sumptuous meal cannot be over emphasized then one consider white bread</p>\r\n'),
	(49, NULL, 'Welcome Subtitle', 'Welcome Subtitle', '<h6>Savory/Pastry/Cake/Coffee/Cookies/Bread</h6>\r\n'),
	(50, NULL, 'We Are Best', 'We Are Best', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>\r\n');
