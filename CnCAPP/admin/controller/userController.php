...
switch ($q){
	...
	case "get_emp_details":
		...
		if($update_permission==1){
			$emp_details = $dbClass->getResultList("select inf.emp_id, inf.full_name, inf.designation_name, 
													...
													inf.email, inf.blood_group, inf.is_active_home_page, inf.remarks, app.is_active, photo
													from user_infos inf 
	...
	case "get_user_info":
		$emp_info = "select inf.emp_id, inf.full_name, inf.designation_name, inf.photo, app.user_name, 
					inf.contact_no, inf.email, inf.blood_group, inf.is_active_home_page, app.is_active
					from user_infos inf 
