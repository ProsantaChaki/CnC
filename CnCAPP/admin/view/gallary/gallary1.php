		...
		<form id="bannerImg_form" name="bannerImg_form" enctype="multipart/form-data" class="form-horizontal form-label-left">   
			<div class="row">
				...
				<div class="col-md-5 imgDiv">
					<img src="<?php echo $activity_url ?>images/no_image.png" width="100%" height="196px" class="img-fluid" id="bannerImg_img">
				</div>
			</div>
			<div class="form-group">
...
$(document).ready(function (){	
	...
	load_data = function load_data(search_txt){
		...
		$.ajax({
			url: project_url+"controller/bannerController.php",
			dataType: "json",
			type: "post",
			async:false,
			data: {
...
*/
$(document).ready(function () {		
	var url = project_url+"controller/bannerController.php";
