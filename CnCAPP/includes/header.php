                    ...
                    <div class="container">
                        ...
                        <div class="menu-main">
                            <ul>
                                ...
                                <?php 
									if($is_logged_in_customer != "") 
										echo '<li><a href="account.php" class="current-lang" id="my_acc"><i class="fa fa-user" aria-hidden="true" ></i> My Account</a></li>';
									else 
										echo '<li><a href="#" onclick="active_modal(1)" data-toggle="modal" data-target="#loginModal" class="current-lang" id="log_reg"><i class="fa fa-user" aria-hidden="true"></i> Login / Register</a></li>';
								?>
								<li class="has-child">
                                    <a href="shop.php">Shop</a>
                                    <ul class="drop-nav">
									<?php								
										$category_result = $dbClass->getResultList("select * from category where status=1");
								...
								<li><a href="#" data-toggle="modal" data-target="#booktable">Custom Cake</a></li>
