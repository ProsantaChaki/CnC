...
case "apply_cupon":
	...
	if(!isset($_SESSION['cart']) || empty($_SESSION['cart']))$cart = array();
		...
		if(isset($_SESSION['customer_id']) && $_SESSION['customer_id'] != "")
			$cupon_info = $dbClass->getSingleRow("select c_type,amount from cupons where status=1 and cupon_no='$cupon_code' and customer_id = ".$_SESSION['customer_id']." and (DATE_FORMAT(start_date, '%Y-%m-%d') <= '$date' AND DATE_FORMAT(end_date, '%Y-%m-%d') >= '$date')");
		else 
		...
		if($return_details){
			...
			if(isset($_SESSION['customer_email'])){
				...
				if($customer_email){
					...
					$to 	 = $customer_email;
					$from 	 = 'admin@cakencookies.net';
					$subject = "#$invoice_no Order Confirmation from Cakencookies ecommerce site";
					$body 	 = ''; 
							...
							<div class='done_registration '>							    
								<div class='doc_content'>
									<div class='col-md-12'>
										<div class='col-md-6'>
											...
											<div class='byline'>
												...
												<span id='dlv_date'>Delevery Time $delivery_date</span> <br/> 
									...
									<div id='ord_detail_vw'> 
										...
										$body .= '<tr><td colspan="4" align="right" ><b>Balance</b></td><td align="right"><b>'.number_format(($total_order_bill-$total_paid),2).'</b></td></tr>';							
