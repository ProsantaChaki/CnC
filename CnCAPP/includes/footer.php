  <!-- Start Footer -->
        <footer>
            <div class="footer-part wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" style="padding: 10px 0 40px 0;">
                <div class="container">	
						...
						<form class="form" method="post" name="custome-cake-form" id="custome-cake-form">
							...
							<div class="row">
								<div class="col-md-6 col-sm-6 col-xs-12">
									<select class="select-dropbox" name="cc_cake_weight" id="cc_cake_weight">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" name="cc_delevery_date" id="cc_delevery_date" placeholder="Pickup/Delevery Date" class="">
								</div>
								<div class="col-md-6 col-sm-6 col-xs-12">
										...
										<div >
											...
											<div class="col-md-12 col-sm-12 col-xs-12">
												<div class="row">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<a href="javascript:void(0)" onclick="active_modal(3)"class="pull-right" data-toggle="modal" data-target="#forget_passModal" id="send_password"><i class="fa fa-user" aria-hidden="true"></i> Lost your password?</a>
													</div>
												</div>
											</div>
										</div>
...
//datepicker
$('#cc_delevery_date').daterangepicker({
