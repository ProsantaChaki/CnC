							...
							<form method="post" name="checkout-form" id="checkout-form"> 						
								<div class="col-md-7 col-sm-7 col-xs-12 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
									<div class="shop-checkout-left">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											<h6>Delivery/Shipping Details</h6>
										</div>
										<div class="col-md-12 col-sm-12 col-xs-12">
											<br />
											<label> Please select pickup/delivery date and time </label>
											<input type="text" name="pickup_date_time" id="pickup_date_time" placeholder="Pickup/Delivery date and time" class="input-fields date-picker" required>
										</div>									
										<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<div class="col-md-12 col-sm-12 col-xs-1 " id="takeout_div">
										...
										<div class="col-md-12 col-sm-12 col-xs-12 shop-checkout-box">
											...
											<label><input type="radio" name="payment_type" value="3"  id="rocket_payment">Cash On Delivery</label>
									...
									<div class="shop-checkout-right">
										<div class="shop-checkout-box">
											...
											<div class="checkout-total hide" id="delevery_charge_amt_div">
												<h6>DELIVERY CHARGE <small id="delevery_charge_amt">0</small></h6>
											</div>
											<hr>
											<!--<div class="checkout-total">
