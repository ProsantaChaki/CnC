    ...
    <div class="x_content" id="iniial_collapse">		
		<form method="POST"  id="ingredient_form" name="ingredient_form" enctype="multipart/form-data" class="form-horizontal form-label-left">   
			<div class="row">
				...
				<div class="col-md-3">
					<img src="<?php echo $activity_url ?>images/no_image.png" width="70%" height="70%" class="img-thumbnail" id="ingredient_img">
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(!jQuery.isEmptyObject(records_array)){
					...
					var colums_array=["photo*image*"+project_url,"id*identifier*hidden","name","code"];
				...
				if(!jQuery.isEmptyObject(data.records)){
					$.each(data.records, function(i,data){
						...
						if(data.photo == ""){
							...
							$('#ingredient_img').attr("src",project_url+data.photo);
						}
