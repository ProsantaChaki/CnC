...
$(document).ready(function () {		
	...
	load_outlets = function load_outlets(){
		$.ajax({
			...
			success: function(data){
				...
				option_html += '<option value="0">Select Outlet to takeway/Delivery</option>';
	...
	calculate_total_bill = function calculate_total_bill(){
		...
		html_tfoot += '<tr><td colspan="5" align="right"><b>Discount Amount</b></td><td align="right"><input type="hidden" id="discounted_amount" name="discounted_amount" value="'+coupon_amount+'"><b>'+coupon_amount+'</b></td></tr>';
