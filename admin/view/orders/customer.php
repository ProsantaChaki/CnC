        ...
        <table id="customer_Table" name="table_records" class="table table-bordered  responsive-utilities jambo_table table-striped  table-scroll ">
            <thead>
                <tr class="headings">
                    ...
                    <th class="column-title" width="15%">Age</th>
		...
		<form id="customer_form" name="customer_form" enctype="multipart/form-data" class="form-horizontal form-label-left">   
			<div class="row">
				<div class="col-md-9">
					...
					<div class="form-group"> 
						<label class="control-label col-md-2 col-sm-2 col-xs-6" >Address<span class="required">*</span></label>
				...
				<div class="col-md-3">
					<img src="<?php echo $activity_url ?>images/no_image.png" width="70%" height="70%" class="img-thumbnail" id="customer_img">
			...
			success: function(data){
				...
				if($.trim(search_txt) == "Print"){
					...
					if(!jQuery.isEmptyObject(records_array)){
						...
						var colums_array=["photo*image*"+project_url,"customer_id*identifier*hidden","full_name","age","email","contact_no*center","address","status_text"];
