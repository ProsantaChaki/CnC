		...
		<form id="emp_form" name="emp_form" enctype="multipart/form-data" class="form-horizontal form-label-left">   
			<div class="row">
				<div class="col-md-9">
					...
					<div class="form-group">
						<label class="control-label col-md-2 col-sm-2 col-xs-6">In Home</label>
						<div class="col-md-4 col-sm-4 col-xs-6">
							<input type="checkbox" id="is_active_home_page" name="is_active_home_page" required class="form-control col-lg-12"/>
						</div>
