									...
									$.each(data.records, function(i,datas){ 			
										...
										/* html += '<tr><td colspan="2">';
										 $.each(datas.module_activity, function(i,module_activity){ 
											module_activity_arr = module_activity.split("*");	
											if(module_activity_arr[2]==1) 					 
												html += '<div class="col-md-3" ><input type="checkbox" name="permision[]" class="tableflat"  checked="checked" value="'+module_activity_arr[0]+'"/> '+module_activity_arr[1]+'</div>';								
											else
												html += '<div class="col-md-3" ><input type="checkbox" name="permision[]"  class="tableflat"  value="'+module_activity_arr[0]+'"/> '+module_activity_arr[1]+'</div>';								
										 });
										html += '</td></tr>'; */										
									});
									html +='</table>';	
